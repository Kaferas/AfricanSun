...
@section('title', 'Creer un Nouveau Utilisateur')
@section('content')
    ...
    <div class="col-xl-12 col-lg-12 col-md-1 col-sm-12 col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="mt-2">Creer un Utilisateur</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between mt-4 mb-3">
                        ...
                        @error('colline')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <input type="text" name="zone" id="zone" class="zone form-control mb-3" placeholder="Zone" required hidden>
                        @error('zone')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    </div>
